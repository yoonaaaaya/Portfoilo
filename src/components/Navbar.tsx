  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="font-extrabold tracking-tighter text-xl text-brand-dark">Yoona Park</span>
      </div>

      <div className="hidden md:flex items-center gap-8 text-xs font-black tracking-widest uppercase">
        <a href="#highlights" className="text-brand-gray hover:text-brand-purple transition-colors">학력 및 수상</a>
        <a href="#experience" className="text-brand-gray hover:text-brand-purple transition-colors">경력사항</a>
        <a href="#projects" className="text-brand-gray hover:text-brand-purple transition-colors">프로젝트</a>
